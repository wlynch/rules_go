...
# c.f. #135
# TODO(yugui) Remove go_rules_bzl_only_for_internal_use argument when we drop
# support of Bazel 0.3.2.
def go_proto_repositories(shared=1, go_rules_bzl_only_for_internal_use=None):
  ...
  new_go_repository(
      ...
      go_rules_bzl_only_for_internal_use = go_rules_bzl_only_for_internal_use,
  )
  if shared:
